...
const NAV = [
    ...
    },
    {
        group: 'Talent',
        items: [
            { label: 'Staff Profiles', href: '/admin/staff-profiles', icon: 'staff' },
            { label: 'Roles & Sub-roles', href: '/admin/talent-taxonomy', icon: 'taxonomy' },
            { label: 'Client Shortlists', href: '/admin/shortlists', icon: 'shortlists' },
        ],
    },
    {
        group: 'Site',
...
const ICONS = {
    ...
    taxonomy: <><path d="M3 5h8" /><path d="M3 12h5" /><path d="M3 19h5" /><path d="M13 12h8" /><path d="M13 19h8" /><path d="M8 12v7" /></>,
    shortlists: <><path d="M9 11l3 3L22 4" /><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" /></>,
