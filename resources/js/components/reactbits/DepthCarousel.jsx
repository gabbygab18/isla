    ...
    >
      <div className="depth-carousel__stage" ref={stageRef}>
        {data.map((item, i) => (
          ...
          >
            {/* Added: profiles without a photo get a branded gradient tile
                (matching the ChromaGrid palette) instead of a bare <img>. */}
            {item.image ? (
              ...
              <div
                ...
                style={{
                  background: item.gradient || 'linear-gradient(160deg, #c17579, #2b2723)',
                  display: 'flex',
                  alignItems: 'center',
