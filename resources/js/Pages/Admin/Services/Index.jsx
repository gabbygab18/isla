                            ...
                            {services.map((s, i) => (
                                <TableRow key={s.id} className="border-hairline-soft">
                                    ...
                                    <TableCell className="whitespace-normal">
                                        ...
                                        {s.summary && <p className="mt-0.5 max-w-md text-[13px] text-ink-soft">{s.summary}</p>}
                                    </TableCell>
                                    <TableCell className="font-mono text-[12.5px] text-ink-soft">{s.slug}</TableCell>
                                    <TableCell><StatusPill active={s.is_active} /></TableCell>
